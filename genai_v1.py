...
st.title('<h1 style="color:blue;font-size:32px;">EliteGenera Finance</h1>')
...
st.markdown('<h2 style="color:green;font-size:24px;">Gen AI: Exports diversification for Morocco</h2>', unsafe_allow_html=True)
